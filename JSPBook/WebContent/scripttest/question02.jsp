...
$(function(){
	...
	$("#clickBtn").on("click", function(){
		var table = $("<table class='table table-bordered' width='100%' style='text-align:center; font-size:24px;'>");
		table.append($("table").html());
		
		$("#output").html(table);
		
        $("#output td:contains('정소현')").addClass('highlight');
	});
});
</script>
</html>
